...
public class BronzeAgeTachibana {
    ...
    // Creates a creative tab with the id "bronze_age_tachibana:example_tab" for the example item, that is placed after the combat tab
    ...
    public BronzeAgeTachibana(final FMLJavaModLoadingContext context) {
        ...
        CreativeTabs.registerCreativeTabs(CREATIVE_MODE_TABS);
