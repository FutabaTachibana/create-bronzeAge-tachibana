...
@Mod.EventBusSubscriber(modid = BronzeAgeTachibana.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config
{
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER
            ...
            .defineListAllowEmpty("items", List.of("iron_ingot"), Config::validateItemName);
