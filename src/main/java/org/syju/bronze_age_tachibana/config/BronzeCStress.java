package org.syju.bronze_age_tachibana.config;
...
public class BronzeCStress extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            ...
            ResourceLocation id = BronzeAgeTachibana.asResource(builder.getName());
    ...
    private static void assertFromCreate(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(BronzeAgeTachibana.MODID)) {
            throw new IllegalStateException("Non-CAB blocks cannot be added to CAB's config.");
        }
    }
